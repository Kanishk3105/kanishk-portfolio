...
const About = () => {
  ...
  return (
    <>
      ...
      >
        I'm Kanishk Chhachra, a B.Tech Computer Science (AI/ML) graduate
        passionate about Artificial Intelligence, Machine Learning, Backend
        Development, and Full-Stack Engineering. I specialize in building
        intelligent applications using Computer Vision, OCR, NLP, and scalable
        backend systems. My goal is to create impactful products that solve
      ...
      <button
        ...
        onClick={() =>
          window.open(
            "https://drive.google.com/file/d/1ZHlv29vxJrl5rivNN7ZFjzCeQ92mrD4T/view?usp=drive_link",
            "_blank",
          )
        }
      >
